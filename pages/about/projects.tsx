...
// main project image
import LUDOang from "./path-to-image/ludoang.png";
import ReactChatMain from "./path-to-image/react-chat-main.png";
import ReactTools from "./path-to-image/react-tools.png";
import AlephBot from "./path-to-image/aleph-bot.png";
import LPTK from "./path-to-image/lptk.png";
import NUINO from "./path-to-image/nu-ino.png";
import UnmuhJember from "./path-to-image/unmuh-jember.png";
import Porto from "./path-to-image/porto.png";
...
const projects: Project[] = [
  {
    ...
    bg: LUDOang, // Pastikan import gambar LUDOang sudah ada
    slug: "ludoang",
  },
  {
    ...
    bg: ReactChatMain, // Pastikan import gambar ReactChatMain sudah ada
    slug: "react-chat",
  },
  {
    title: "React Tools",
    ...
    bg: ReactTools, // Pastikan import gambar ReactTools sudah ada
    slug: "react-tools",
  },
  {
    ...
    bg: AlephBot, // Pastikan import gambar AlephBot sudah ada
  ...
  },
  {
    ...
    bg: LPTK, // Pastikan import gambar LPTK sudah ada
    slug: "lptk-cup-2023",
  },
  {
    ...
    bg: NUINO, // Pastikan import gambar NUINO sudah ada
    slug: "nu-ino-website",
  },
  {
    ...
    bg: UnmuhJember, // Pastikan import gambar UnmuhJember sudah ada
  ...
  },
  {
    ...
    bg: Porto, // Pastikan import gambar Porto sudah ada
        ...
        <div className="container grid w-screen grid-cols-1 gap-4 px-10 mx-auto mb-10 cursor-pointer md:grid-cols-2">
          ...
          {projects.map((project, index) => (
            <Link href={`projects/${project.slug}`} key={index}>
              ...
              >
                <img
                  src="/public/projects/LUDOang/ludo1.png"
                  alt="Example Image"
                  style={{ width: "100%", height: "auto" }}
                />
